...
private:
  ...
  ros::Subscriber current_loa_sub_, loa_utility_delta_sub_, human_loa_sub_ , ai_loa_sub_, neg_enabled_sub_;
  ...
  void negEnabledCallback(const std_msgs::Bool::ConstPtr& msg);
  ...
  std_msgs::Bool negotiation_enabled_;
  ...
  bool loa_changed_, negotiation_is_active_, negotiation_enabled_; 
